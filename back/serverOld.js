...
const { Server: ServerOld } = require('socket.io');
...
const io = new ServerOld(httpServer, {
    cors: {
        origin: "http://localhost:5173", // Remplacez par l'origine autorisée
...
io.on('connection', (socket) => {
    ...
    socket.on('start game', async (roomId, ) => {
        ...
        const urlTracklist = room.category.tracklist;
        const nbMusics = room.songCount
